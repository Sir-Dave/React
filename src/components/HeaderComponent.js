...
class Header extends Component{
    ...
    render(){
        return(
            //Short form syntax for React.Fragment
            <>
               <Navbar dark expand="sm">
                    <div className="container">
                        <NavbarToggler onClick={this.toggleNav}/>
                        <NavbarBrand className="mr-auto" href="/">
                            <img src="assets/images/logo.png" width="41" height="30" alt="Ristoante Con Fusion"/>
                        </NavbarBrand>
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.state.toggleModal}>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup check>
                                <Label check>
                                    <Input type="checkbox" id="username" name="remember"
