                     ...
                     <Form onSubmit={this.handleSubmit}>
                        <FormGroup row>
                         ...
                         <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input id="telnum" type="tel" name="telnum" placeholder="Tel. Number"
                                    ...
                                    value= {this.state.telnum} onBlur={this.handleBlur("telnum")} onChange={this.handleInputChange}/>
                                     <FormFeedback>{errors.telnuml}</FormFeedback>
                            </Col>
                        </FormGroup>
                         <FormGroup row>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input id="message" type="textarea" rows="12" name="message"
